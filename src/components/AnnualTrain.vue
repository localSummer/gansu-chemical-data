            ...
            getData(chartInstances) {
                ...
                this.$http.get(`/api/stat/areainfos?provinceId=1`).then((response) => {
                    if (response.data.returncode === 0) {
                        ...
                        annualTrainOne.title.text = result.AttendRate + '%';
                        annualTrainTwo.title.text = result.PassRate+ '%';
                        annualTrainThree.title.text = result.SatisfyRate + '%';
                        annualTrainOne.series[0].data[0].value = result.AttendRate;
                        annualTrainOne.series[0].data[1].value = 100 - result.AttendRate;
                        annualTrainTwo.series[0].data[0].value = result.PassRate;
                        annualTrainTwo.series[0].data[1].value = 100 - result.PassRate;
                        annualTrainThree.series[0].data[0].value = result.SatisfyRate;
                        annualTrainThree.series[0].data[1].value = 100 - result.SatisfyRate;
